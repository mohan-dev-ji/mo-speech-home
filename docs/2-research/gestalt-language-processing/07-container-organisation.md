...
**Relationship to the rest of the dossier:** this is the *organisation* layer; [doc 6](06-sentence-builder-concept.md) is the *unit/composition* layer; [doc 4](04-glp-in-mo-speech.md) is the *feature* layer (morphology engine, the seven non-negotiables). All three stay inside the one-app decision. When this firms up, graduate it into a feature spec / ADR under `docs/4-builds/` — the module + tree model is architectural enough to warrant an ADR.

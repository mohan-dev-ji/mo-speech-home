...
>
> **System documented (2026-07-28).** How the shipped system actually works — content authored live in the `libraryModules` Convex table, mirrored to git-committed JSON, restorable into a fresh deployment — is written up in [FEAT-002 — Library Modules: Authoring, Backup & Restore](../../4-builds/features/FEAT-002-library-modules-backup-restore.md). Read that for the mechanics; this doc is retained for the product *why*.

...
- [`docs/4-builds/features/FEAT-002-library-modules-backup-restore.md`](../features/FEAT-002-library-modules-backup-restore.md) — was the operational catalogue tracker; rewritten (2026-07-28) to document the library-modules authoring/backup/restore system
